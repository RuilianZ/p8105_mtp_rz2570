...
* **EEOP** is **enlarged external occipital protuberance**. `eop_size` in this data can be used to calculate **prevalence**, which is `r eeop_prevalence`. This value is different from author-stated value 33%.  
